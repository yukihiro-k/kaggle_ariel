...
class TransitModel:
    ...
    def _phase_detector(self, signal):
        ...
        phase2 = int(np.argmax(g2)) + min_index
        return phase1, phase2
...
if __name__ == "__main__":
    ...
    with torch.inference_mode():
        predictions = model_1d.predict_all(preprocessed_data)
    ...
    # AIRS: 軽スムージング＆ブレンド
    win, poly = Config.AIRS_SMOOTH_WINDOW, Config.AIRS_SMOOTH_POLY
    predictions2_smooth = _savgol_safe(predictions2, win, poly, axis=1)
